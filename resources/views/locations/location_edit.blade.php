...
@section('breadcrumbs')
    {!! Breadcrumbs::render('location_edit',$location->id) !!}
@stop
...
@section('content')
    ...
    <div class="box box-primary" style="padding:20px">
        ...
        <div class="row" id="form">
            <div class="col-md-12">
                <form action="{{route('location_edit',["location_id"=>$location->id])}}" id="location_form" class="form-horizontal" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9 col-md-9 col-lg-10">
                                        <input type="text" name="name" value="{{ $location->name }}" class="form-control" id="name" >
                                ...
                                <div class="form-group">
                                    <label for="address" class="col-sm-3 col-md-3 col-lg-2 control-label ">Address:</label>	<div class="col-sm-9 col-md-9 col-lg-10">
                                        <textarea name="address" cols="17" rows="5" id="address" class="form-control text-area">{{ $location->address }}</textarea>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label for="phone" class="col-sm-3 col-md-3 col-lg-2 control-label ">Phone:</label>	<div class="col-sm-9 col-md-9 col-lg-10">
                                        <input type="text" name="phone" value="{{ $location->phone }}" class="form-control" id="phone" >
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9 col-md-9 col-lg-10">
                                        <input type="text" name="printer_ip" value="{{ $location->printer_ip }}" class="form-control" id="printer_ip">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9 col-md-9 col-lg-10">
                                        <input type="text" name="printer_port" value="{{ $location->printer_port }}" class="form-control" id="printer_port">
