...
<div class="row">
    <div class="col-md-12">
        <div class="box box-primary">
            ...
            <form id="menu_form" method="POST" action="{{ route('add_menu_post') }}">
                {{ csrf_field() }}
                <div class="box-body">
            		...
            		<div class="row">
            			<div class="col-md-4">
            				<div class="form-group">
            		            ...
            		            <img id="logoPreview" src="{{ url('/images/default.jpg') }}" alt="logo" height="70px" width="70px" />
            		...
            		<div class="row">
            			<div class="col-md-3">
            				<button class="btn btn-primary" id="btn_submit">Add Menu</button>
            			</div>
...
<script type="text/javascript">
	$(function() {
		...
		$('#btn_add_product').click(function(event) {
			...
			if (selected_items.indexOf(product_id) != -1) {
				alert('Already added');
				return ;
			}
