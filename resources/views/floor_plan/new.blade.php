...
@section('pageTitle','New Floor Plan')

@section('breadcrumbs')
    {!! Breadcrumbs::render('new_floor_plan') !!}
@stop
...
@section('content')
<form action="{{ route('post_new_floor_plan') }}" method="post">
    {{ csrf_field() }}
    <div class="row">
        <div class="col-md-12">
                            ...
                            <tr>
                                @for($j=1; $j<=$column; $j++)
                                    <td class="item">
                                        ...
                                        <div class="item_info">
                                            <b>Name: </b><span class="span_name"></span><br>
                                            <b>No. of Seat: </b><span class="span_seat"></span>
                                            <input class="name" type="hidden" name="name[]">
                                            <input class="seat" type="hidden" name="seat[]">
