...
@section('pageTitle','Edit Item Kit')

@section('breadcrumbs')
    {!! Breadcrumbs::render('item_kit_edit',$itemKit->item_kit_id) !!}
@stop
...
@section('content')
    <div class="box box-primary" style="padding:20px">
        ...
        <div class="row" id="form">
            <div class="col-md-12">
                <form action="{{route('item_kit_edit',['item_kit_id'=>$itemKit->item_kit_id])}}" id="item_kit__edit_form" class="form-horizontal" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9 col-md-9 col-lg-10">
                                        <select class="item-selector  col-md-10" onchange="appendMenuItem(this)">
                                            <option id = "option-0" value="0" selected="selected">
                                                Select an item
                                            </option>
                                            @foreach($items as $anItem)
                                                <option id ="option-{{$anItem->id}}" value="{{$anItem->id}}">
                                                    {{$anItem->item_name}}
                                                </option>
                                            @endforeach
                                        </select>
                                        <label class ="alert alert-info text-center">
                                            Item Kits are made up of 1 or more items to see as a group. Add your first item using this field.
                                        </label>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-9 col-md-9 col-lg-10">
                                        <table style="font-size:12px" class="table table-striped table-hover table-responsive" >
                                            ...
                                            <tbody id = "selected-items">
                                                @foreach($selectedItems as $anItem)
                                                    @if(!is_null($anItem->item_name))
                                                        <tr  id = "append-option-{{ $anItem->item_id }}" >
                                                            <td>
                                                                <a onclick ="DeleteItem({{ $anItem->item_id }})" href="javascript:void(0)">
                                                                    Delete
                                                                </a>
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <input value ="{{$anItem->quantity}}" type ="text" name ="quantity[]">
                                                            </td>
                                                            <input type ="hidden"  name = "selected_value[]" value = "{{ $anItem->item_id }}">
                                                        </tr>
                                                    @endif
                                                @endforeach
                                            </tbody>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9 col-md-9 col-lg-10">
                                        <input type="text" name="isbn" value="{{ $itemKit->isbn }}" class="form-control" id="isbn" >
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9 col-md-9 col-lg-10">
                                        <input type="text" name="product_id" value="{{ $itemKit->product_id }}" class="form-control" id="product_id">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9 col-md-9 col-lg-10">
                                        <input  type="text" name="item_kit_name" value="{{ $itemKit->item_kit_name }}" class="form-control" id="item_kit_name">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9 col-md-9 col-lg-10">
                                        <select  name = "item_kit_category" class="form-control" value = "{{ $itemKit->category_id }}">
                                            <option></option>
                                            <option>none</option>
                                            @foreach ($categoryList as $aList)
                                                @if($aList->id==$itemKit->category_id)
                                ...
                                <div class="form-group">
                                    <label for="manufacturer" class="col-sm-3 col-md-3 col-lg-2 control-label ">Manufacturer:</label>			<div class="col-sm-9 col-md-9 col-lg-10">
                                        <select  name = "item_kit_manufacturer"  class="form-control">
                                            <option></option><option>none</option>
                                            @foreach ($manufacturerList as $aList)
                                                @if($aList->id==$itemKit->manufacturer_id)
                                                    <option value = "{{$aList->id}}" selected>
                                ...
                                <div class="form-group">
                                    <label for="description" class="col-sm-3 col-md-3 col-lg-2 control-label wide">Description:</label>					<div class="col-sm-9 col-md-9 col-lg-10">
                                        <textarea name="description" value = "{{ $itemKit->item_kit_description }}" cols="17" rows="5" id="description" class="form-control  text-area"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        <label for="cost_price" class="col-sm-3 col-md-3 col-lg-2 control-label required wide">Cost Price (Without Tax):</label>						<div class="col-sm-9 col-md-9 col-lg-10">
                                            <div class="input-group">
                                                ...
                                                <input  type="text" name="cost_price" value = "{{ $itemKit->cost_price }}" size="8" id="cost_price" class="form-control form-inps">
                                    ...
                                    <div class="form-group">
                                        <label for="unit_price" class="col-sm-3 col-md-3 col-lg-2 control-label required wide">Selling Price:</label>					<div class="col-sm-9 col-md-9 col-lg-10">
                                            <div class="input-group">
                                                <span class="input-group-addon bg"><span class="">$</span></span>
                                                <input  type="text" name="unit_price" value = "{{ $itemKit->selling_price }}" size="8" id="unit_price" class="form-control form-inps">
