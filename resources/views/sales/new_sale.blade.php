        ...
        function appendItemToCartAuto(item){
            ...
            if(item.name!==null) {
                if(item.useScanPrice){
                    var additionalPrice = item.name +('@'+Math.floor(item.new_price*100)/100+'/'+ '{{ $settings["item_size"] }}');
                ...
                if(item.useScanPrice){
                    var additionalPrice = ('@'+Math.floor(item.new_price*100)/100+'/'+ '{{ $settings["item_size"] }}');
