...
@section('pageTitle','Customer Detail Report')

@section('breadcrumbs')
    {!! Breadcrumbs::render('report_customer_detail') !!}
@stop
                ...
                <div class="form-inline">
                    <div class="form-group" style="float:left">
                        <div class="input-group" >
                            <select class="form-control customerSelect" id="customer_id">
 ...
 <script>
     ...
     $(document).ready(function(e) {
        ...
        table = $('.table').DataTable({
         ...
         $('#order_by,  #start_date_formatted, #end_date_formatted, #customer_id').change(function() {
             $('.data').addClass('hide');
             ...
             $.ajax({
                 ...
                 $('.table').empty();
                 $('#DataTables_Table_0').html(tableData);
