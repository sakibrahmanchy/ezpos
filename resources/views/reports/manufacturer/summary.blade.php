...
@section('pageTitle','Manufacturer Summary Report')

@section('breadcrumbs')
    {!! Breadcrumbs::render('report_manufacturer_summary') !!}
@stop
        ...
        <div class="data">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-striped table-reports tablesorter stacktable small-only">
                    <thead>
                    <tr>
                        <th align="left" class="header">Manufacturer</th>
 ...
 <script>
     ...
     $(document).ready(function(e) {
         ...
         $('#order_by,  #start_date_formatted, #end_date_formatted').change(function() {
             ...
             $.ajax({
                 method: "POST",
                 url: "{{ route('report_manufacturer_ajax') }}",
                 data: {
