...
@section('pageTitle','Categories Summary Report')

@section('breadcrumbs')
    {!! Breadcrumbs::render('report_category_summary') !!}
@stop
 ...
 <script>
     ...
     $(document).ready(function(e) {
         ...
         $('#order_by,  #start_date_formatted, #end_date_formatted').change(function() {
             ...
             $.ajax({
                 method: "POST",
                 url: "{{ route('report_category_ajax') }}",
                 data: {
                 ...
                 data.sale.forEach(function(item){
                    tableData += "<tr>";
                    tableData+=" <td> "+ item.category_name +"</td>";
                    tableData+="<td>";
                    if(item.subtotal>=0)
