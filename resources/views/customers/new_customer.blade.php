...
@section('pageTitle','New Customer')

@section('breadcrumbs')
    {!! Breadcrumbs::render('new_customer') !!}
@stop
    ...
    <div class="box box-primary" style="padding: 20px;">
        ...
        <div class="row" id="form">
            ...
            <div class="col-md-12">
                ...
                <form action="{{route('new_customer')}}" id="customer_form" class="form-horizontal" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                    {{-- {{ csrf_field() }}--}}
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="loyalty_card_number" class="col-sm-3 col-md-3 col-lg-2 control-label">Loyalty Number:</label>						<div class="col-sm-9 col-md-9 col-lg-10">
                                            <input type="text" name="loyalty_card_number" value="{{ old('loyalty_card_number') }}" id="loyalty_card_number" class="form-control">
                                        </div>
                                    </div>
                                </div>
                            </div>
