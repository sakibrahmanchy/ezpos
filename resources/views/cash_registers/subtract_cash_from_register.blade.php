...
@section('pageTitle','Subtract Cash From Register')
        ...
        <div class="col-md-12">
            <div class="panel panel-piluku">
                ...
                <div class="panel-body">
                    <h3>You have already subtracted ${{$subtracted_amount}} from the register</h3><form action="{{route('subtract_cash_from_register')}}" id="register_add_subtract_form" class="form-horizontal" method="post" accept-charset="utf-8" novalidate="novalidate">
                        ...
                        <a href="javascript:void(0)" onclick=""></i> Pop Open Cash Drawer</a>				</div>
